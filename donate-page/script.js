...
var GithubLink  =   "https://github.com/zhijielee/hexo-theme-clover/";
var PayPalLink  =   "https://www.paypal.me/EricLee1998";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    // 'btc_donate'	:	'../sample1/images/BTCQR.png',	// 二维码路径
    'alipay_donate'	:	'images/AliPayQR.jpeg',	// 支付宝二维码
    'alipay_donate_link'   :   'https://www.paypal.me/EricLee1998',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'images/WeChatQR.jpeg'
};
